...
<div class="section about ">
   <div class="container">
      <div class="row">
         <div class="col-12">
            <div class="titlepage">
               <h2><strong class="black"> Comment ça marche </strong> ?</h2>
               <span>Après s'être inscrit gratuitement, vous aurez accès aux pages de paris. Dans celle ci vous retrouverez les côtes,les sommes mises en jeux, il vous sera possible de parier vous mêmes sur une course un pilote ou bien les deux !</span>
            </div>
         </div>
      </div>
   </div>
   ...
   <div class="container">
      <div class="row">
         <div class="col-sm-12">
            ...
            <div id="formations" class="carousel slide" data-ride="carousel">

               <!-- Indicators -->
               <ul class="carousel-indicators">
                  <li data-target="#formations" data-slide-to="0" class="active"></li>
                  <li data-target="#formations" data-slide-to="1"></li>
                  <li data-target="#formations" data-slide-to="2"></li>
               </ul>
               ...
               <a class="carousel-control-prev" href="#formations" data-slide="prev">
                  <span class="carousel-control-prev-icon"></span>
               </a>
               <a class="carousel-control-next" href="#formations" data-slide="next">
